...
class PepperLaserFilter(Node):
    def __init__(self):
        ...
        self.get_logger().info("Fixing invalid ranges and LaserScan geometry")
        self.get_logger().info("Using current ROS time for scan timestamps")
    ...
    def callback(self, msg: LaserScan):
        ...
        # Important:
        # Use live ROS time, not stamp 0.
        # This lets SLAM Toolbox publish a valid live map -> odom transform.
        ...
        # Important:
        # Pepper raw scan has 61 ranges but original angle_max implied 62.
        # Recompute angle_max from the real number of ranges.
